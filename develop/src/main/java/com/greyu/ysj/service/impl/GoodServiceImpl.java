...
import com.greyu.ysj.mapper.AuctionHistoryMapper;
...
//        List<Good> list = this.goodMapper.getAllByGood(good);
    ...
    @Override 
    public List<Good> getGoodsByCategoryAndName(String name, Integer categoryId){
    	GoodExample goodExample = new GoodExample();
    	GoodExample.Criteria criteria = goodExample.createCriteria();
    	
    	if("null" != name) {
    		criteria.andGoodNameLike(name);
    	}
    ...
    @Override
    public List<Good> getRetentionGoods(){
    	return this.goodMapper.selectByType("retention");
    }
    
    @Override
    public List<Good> searchByKeyword(String keyword){
    	//return this.goodMapper.selectByKeyword("%" + keyword + "%");
    	return null;
    }
    
    @Override
    public List<Good> selectGoodsByType(String goodType){
    	return this.goodMapper.selectByType(goodType);
    }
    
    @Override
    public List<Question> getQuestionsByGoodId(Integer goodId){
    	return this.questionMapper.selectByGoodId(goodId);
    }
    ...
    @Override 
    public void submitAuction(AuctionHistory auctionHistory) {
    	
    	this.auctionHistoryMapper.insert(auctionHistory);
    	
    	int goodId = auctionHistory.getGoodId();
    	
    	Integer priceCount = 
    			this.auctionHistoryMapper.selectAuctionCount(goodId);
    	AuctionHistory maxAuction = 
    			this.auctionHistoryMapper.selectMaxAuction(goodId);
    	
    	this.goodMapper.updateAuction(goodId, 
    			maxAuction.getPrice(), 
    			maxAuction.getUserId(), 
    			maxAuction.getPriceDate(), 
    			priceCount);
    }
    
    @Override
    public List<Good> getBuyerGoods(Integer userId){
    	return this.goodMapper.selectByBuyer(userId);
    }
    
    @Override
    public List<Good> selectSupplierGoodsByStatus(String status, Integer userId){
    	return this.goodMapper.selectSupplierGoodsByStatus(status, userId);
    }
    
    @Override
    public List<Good> selectSupplierPaidGoods(Integer userId){
    	return this.goodMapper.selectSupplierPaidGoods(userId);
    }
    
    @Override
    public List<Good> selectBySupplier(Integer userId){
    	return this.goodMapper.selectBySupplier(userId);
    }
}
